...
A game made for Ludum Dare 59, built with Godot 4.6 and GDScript. The `util/` folder contains reusable utility components (debug overlays, camera effects, audio management, scene transitions, procedural animation, etc.) originally from EctGodotUtils.
